...
execSync(`cd homebrew-idk && git add . && git commit --message "Update from https://github.com/${process.env.GITHUB_REPOSITORY}/commit/${process.env.GITHUB_SHA}" && git push -u origin master`)
